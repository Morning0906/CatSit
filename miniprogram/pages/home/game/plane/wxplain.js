...
var config = {
    ...
    /*wx.getImageInfo({
        src: flyimages["bg"].src,
        success:function(res){
            flyimages["bg"].src = res.path
            console.log(res)
        },
        fail:function(err){
            console.log(err);
...
//};
wx.getImageInfo({
    src: flyimages["loading1"].src,
    success:function(res){
        flyimages["loading1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["loading2"].src,
    success:function(res){
        flyimages["loading2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["loading3"].src,
    success:function(res){
        flyimages["loading3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["logo"].src,
    success:function(res){
        flyimages["logo"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["bomb"].src,
    success:function(res){
        flyimages["bomb"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["cartridge"].src,
    success:function(res){
        flyimages["cartridge"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["cartridge_power"].src,
    success:function(res){
        flyimages["cartridge_power"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["die1"].src,
    success:function(res){
        flyimages["die1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["die2"].src,
    success:function(res){
        flyimages["die2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me"].src,
    success:function(res){
        flyimages["me"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me_2"].src,
    success:function(res){
        flyimages["me_2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me_die1"].src,
    success:function(res){
        flyimages["me_die1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me_die2"].src,
    success:function(res){
        flyimages["me_die2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me_die3"].src,
    success:function(res){
        flyimages["me_die3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["me_die4"].src,
    success:function(res){
        flyimages["me_die4"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain1"].src,
    success:function(res){
        flyimages["plain1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain1_die1"].src,
    success:function(res){
        flyimages["plain1_die1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain1_die2"].src,
    success:function(res){
        flyimages["plain1_die2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain1_die3"].src,
    success:function(res){
        flyimages["plain1_die3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2"].src,
    success:function(res){
        flyimages["plain2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2_die1"].src,
    success:function(res){
        flyimages["plain2_die1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2_die2"].src,
    success:function(res){
        flyimages["plain2_die2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2_die3"].src,
    success:function(res){
        flyimages["plain2_die3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2_die4"].src,
    success:function(res){
        flyimages["plain2_die4"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain2_hurt"].src,
    success:function(res){
        flyimages["plain2_hurt"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3"].src,
    success:function(res){
        flyimages["plain3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_2"].src,
    success:function(res){
        flyimages["plain3_2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die1"].src,
    success:function(res){
        flyimages["plain3_die1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die2"].src,
    success:function(res){
        flyimages["plain3_die2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die3"].src,
    success:function(res){
        flyimages["plain3_die3"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die4"].src,
    success:function(res){
        flyimages["plain3_die4"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die5"].src,
    success:function(res){
        flyimages["plain3_die5"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_die6"].src,
    success:function(res){
        flyimages["plain3_die6"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["plain3_hurt"].src,
    success:function(res){
        flyimages["plain3_hurt"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["prop1"].src,
    success:function(res){
        flyimages["prop1"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
  ...
  wx.getImageInfo({
    src: flyimages["prop2"].src,
    success:function(res){
        flyimages["prop2"].src = res.path
        console.log(res)
    },
    fail:function(err){
        console.log(err);
...
function flyGame( opts ) {
    ...
    function load() {
        ...
        cxt.drawImage( pic.src, x, 250, pic_width, pic_height );
    }
